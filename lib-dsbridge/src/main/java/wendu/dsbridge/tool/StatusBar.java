...
//            window.setNavigationBarColor(Color.TRANSPARENT);
    ...
    public static void tranNavigationBar(Activity activity){
        //全屏，视频模式，包括 底部的 状态栏也都变为透明形态
        Window window = activity.getWindow();
        //全屏 将顶部的 状态栏隐藏掉
...
//
//    } else if (themeStyle() == ThemeStyle.VEDIO) {
//        StatusBar.tranNavigationBar(this);
//
//    } else if (themeStyle() == ThemeStyle.TRANSLUCENTSTATUS) {
